...
CREATE TABLE IF NOT EXISTS products (
  ...
  category ENUM('SNEAKERS','CLOTHING','ACCESSORIES','COLLECTIBLES','SKATEBOARDS','MUSIC','ELECTRONICS','FOOTBALL') NOT NULL,
  subcategory ENUM('HIGH','LOW','LIGHT','PANTS','HOODIE','JACKET','COAT','PUFFER','BOXERS','CREWNECK','TEE','CAP','GLOVES','SHADES','BACKPACK','CARD','FIGURE','PLUSH','SKATEBOARD','SNOWBOARD','CD','VINYL','TAPE','GAMING','HARDWARE','MULTIMEDIA','JERSEYS','TRAINING') NOT NULL,
...
CREATE TABLE IF NOT EXISTS football (
  id VARCHAR(36) PRIMARY KEY,
  scope ENUM('CLUB','NATIONAL') NOT NULL,
  FOREIGN KEY (id) REFERENCES products(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE IF NOT EXISTS electronics (
  id VARCHAR(36) PRIMARY KEY,
  caution BOOLEAN DEFAULT TRUE NOT NULL,
  FOREIGN KEY (id) REFERENCES products(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;